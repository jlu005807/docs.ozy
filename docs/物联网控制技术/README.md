# ⚙️ 物联网控制技术 (IoT Control Technology)
...
- ⚠️ tip:最后实验课有上机考试需要自己独立实现，并且最后的期末考试也需要自己写代码，所以不要想着直接网上找一些代码去糊弄实验课。
- 📝 内容可能存在不完整或不规范之处，欢迎指正。可以评论区指出。
- 🛠️ 实验课真的很涨经验，动手一次比看十页 PPT 有用。真的
- 🏃 别怕慢，肯动手就已经赢一半了。
...
3. 同时对于实验的相关问题，请到[Iot-Control-Technology](https://github.com/jlu005807/Iot-Control-Technology)讨论
